...
class _SeatComponentEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_SeatComponent.ValueType], builtins.type):
...
class MoveRequest(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        seat: global___Seat | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["seat", b"seat"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["seat", b"seat"]) -> None: ...
...
class MoveComponentRequest(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        seat: global___SeatLocation | None = ...,
        component: global___SeatComponent.ValueType = ...,
        position: builtins.int = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["seat", b"seat"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["component", b"component", "position", b"position", "seat", b"seat"]) -> None: ...
...
class CurrentPositionRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["index", b"index", "row", b"row"]) -> None: ...
...
class Seat(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        location: global___SeatLocation | None = ...,
        position: global___Position | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["location", b"location", "position", b"position"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["location", b"location", "position", b"position"]) -> None: ...
...
class Position(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["base", b"base", "cushion", b"cushion", "head_restraint", b"head_restraint", "lumbar", b"lumbar", "side_bolster", b"side_bolster"]) -> None: ...
