...
import seats_pb2 as seats__pb2
...
class Seats(object):
    ...
    def Move(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/sdv.edge.comfort.seats.v1.Seats/Move',
    ...
    def MoveComponent(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/sdv.edge.comfort.seats.v1.Seats/MoveComponent',
    ...
    def CurrentPosition(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/sdv.edge.comfort.seats.v1.Seats/CurrentPosition',
